...
export const TokenTable: React.FC = () => {
  ...
  // Filtrage et tri automatique par poids financier (Valeur USD décroissante)
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      {/* Onglets de filtrage par Réseau Blockchain */}
      ...
      {/* Conteneur de table scrollable avec effets Glassmorphism */}
