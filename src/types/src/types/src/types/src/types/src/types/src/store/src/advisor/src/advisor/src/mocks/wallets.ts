    ...
    return [
      {
        ...
        balance: 4500,
        decimals: 9,
        entryPrice: 0.12, // Sera écrasé ou mis à jour par l'état utilisateur
        marketData: {
          currentPrice: 0.095, // Actuellement en perte légère mais sain (Repli sain)
          volume24h: 6200000,
          volumeChange1h: 4.2,
          liquidity: 850000,
          ath: 0.145,
      ...
      },
      {
        ...
        entryPrice: 0.001,
        marketData: {
          currentPrice: 0.0065, // Multiplié par 6.5x ! Déclenchera la Golden Rule
          volume24h: 18400000,
          volumeChange1h: 32.5,
          liquidity: 2100000,
          ath: 0.007,
    ...
    return [
      {
        ...
        marketData: {
          currentPrice: 510,
          volume24h: 150000,
          volumeChange1h: -45.2, // Chute brutale de volume, faible ratio vol/liq -> Liquidity Trap
          liquidity: 1800000,
          ath: 520,
          holderCount: 1100,
          top10HolderShare: 72, // Très concentré
          ageInDays: 14,
          txCount24h: 180,
          githubCommits30d: 4,
