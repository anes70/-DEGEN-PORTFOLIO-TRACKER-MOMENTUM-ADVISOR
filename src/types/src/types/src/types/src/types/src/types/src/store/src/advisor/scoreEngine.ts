...
export function calculateGlobalTokenScore(token: Token): number {
  ...
  // Moins le top 10 détient de parts, plus c'est décentralisé (sain)
  ...
  else ageScore = 15; // Ultra spéculatif (Degen de l'extrême)
  ...
  // Échelle inversée : si rugPullRiskScore est élevé, le score technique chute
