...
// Map dynamique pour lier les chaînes d'icônes de l'advisor aux composants Lucide réels
...
export const TokenRow: React.FC<TokenRowProps> = ({ token }) => {
  ...
  // États de gestion du mode édition pour le prix d'entrée
  ...
  // Analyse algorithmique temps réel du token
  ...
  return (
    <tr className="border-b border-slate-900/60 bg-slate-950/20 hover:bg-slate-900/30 transition-colors font-mono text-xs">
      ...
      {/* Colonne Prix d'Entrée (Éditable) */}
      <td className="px-6 py-4">
        {isEditing ? (
      ...
      {/* Colonne Advisor Signal & Score (0-100) */}
      <td className="px-6 py-4">
