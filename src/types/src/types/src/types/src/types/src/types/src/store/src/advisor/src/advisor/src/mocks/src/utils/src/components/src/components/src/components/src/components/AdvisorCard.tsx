...
import { AdvisorSignal } from '../types/advisor';
...
// Système de poids des signaux pour afficher l'alerte la plus critique en premier
...
export const AdvisorCard: React.FC = () => {
  ...
  // Génération et tri de tous les signaux actifs du portefeuille
  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 font-mono">
      {/* Colonne de gauche : Sélecteur de signaux actifs */}
      ...
      {/* Colonne du milieu & droite : Focus d'analyse avancé */}
      <div className="lg:col-span-2 bg-slate-950 border border-slate-900 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
        {/* Effet lumineux d'arrière-plan adaptatif selon la couleur du signal */}
        <div 
        ...
        <div>
          ...
          {/* Corps de l'explication / Conseil d'action direct */}
          ...
          {/* Liste des déclencheurs mathématiques de la blockchain */}
        ...
        {/* Pied de carte avec rappel de responsabilité mathématique */}
